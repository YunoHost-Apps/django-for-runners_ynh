...
from for_runners_ynh.cli_dev import app
...
def install():
    """
    Install requirements and 'for_runners_ynh' via pip as editable.
    """
...
def publish():
    ...
    publish_package(module=for_runners_ynh, package_path=get_project_root())
