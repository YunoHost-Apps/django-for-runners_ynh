...
class DjangoYnhTestCase(HtmlAssertionMixin, TestCase):
    ...
    def test_settings(self):
        ...
        self.assertTrue(
            str(settings.LOG_FILE_PATH).endswith('/local_test/var_log_django-for-runners.log'),
        ...
        self.assertTrue(log_filename.endswith('/local_test/var_log_django-for-runners.log'), log_filename)
        self.assertEqual(
